...
const FileInput = forwardRef(({ label, onChange, accept, variant = "dropzone", placeholder, previewUrl, ...props }, ref) => {
  ...
  const renderContent = () => {
    if (isAvatar) {
      return (
        <div className={styles.avatarWrapper} onClick={() => inputRef.current?.click()}>
          {currentPreview ? (
